...
const Homepage = ({ blogs }: Props) => {
  ...
  return (
    ...
    <Head>
        ...
        <meta property="og:image" content="https://mushroom-blog-omega.vercel.app/images/launam.jpg" />
        ...
        <meta name="twitter:image" content="https://mushroom-blog-omega.vercel.app/images/launam.jpg" />
      </Head>
    <Box>
      <Header />
